...
var Particles = class _Particles extends import_react.Component {
  ...
  async loadParticles() {
    ...
    const id = this.props.id ?? _Particles.defaultProps.id ?? defaultId, container = this.props.url ? await tsParticles.loadJSON(id, this.props.url) : await tsParticles.load(id, this.props.params ?? this.props.options);
    await cb(container);
  }
};
